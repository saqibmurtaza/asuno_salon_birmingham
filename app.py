...
# async def fetch_booked_times(date: str, service: str):
#     """Ask backend for booked times via API"""
...
#             # Always enforce expected structure
#             return {
#                 "date": data.get("date"),
...
#             print("⚠️ Error in fetch_booked_times:", repr(e))
#             try:
#                 print("Raw response text (if available):", resp.text)  # type: ignore[name-defined]
#             except Exception:
#                 pass
...
#         )
#     ).send()
#     await cl.Message(content=with_aria_footer(OPENING_HOURS)).send()
#     await send_followup_buttons("✨ What would you like to do next?")
